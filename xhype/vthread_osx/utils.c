...
//   VMCS_CR0_MASK)); printf("VMCS_CR0_SHADOW:               0x%llx\n",
//          rvmcs(vcpu, VMCS_CR0_SHADOW));
//   printf("VMCS_CR4_MASK:                 0x%llx\n", rvmcs(vcpu,
//   VMCS_CR4_MASK)); printf("VMCS_CR4_SHADOW:               0x%llx\n",
...
//          rreg(vcpu, HV_X86_RAX), rreg(vcpu, HV_X86_RBX), rreg(vcpu,
//          HV_X86_RCX), rreg(vcpu, HV_X86_RDX));
//   printf("rsi: 0x%llx rdi: 0x%llx rbp: 0x%llx rsp: 0x%llx\n",
//          rreg(vcpu, HV_X86_RSI), rreg(vcpu, HV_X86_RDI), rreg(vcpu,
//          HV_X86_RBP), rreg(vcpu, HV_X86_RSP));
//   printf("r8:  0x%llx r9:  0x%llx r10: 0x%llx r11: 0x%llx\n",
//          rreg(vcpu, HV_X86_R8), rreg(vcpu, HV_X86_R9), rreg(vcpu,
//          HV_X86_R10), rreg(vcpu, HV_X86_R11));
//   printf("r12: 0x%llx r13: 0x%llx r14: 0x%llx r15: 0x%llx\n",
//          rreg(vcpu, HV_X86_R12), rreg(vcpu, HV_X86_R12), rreg(vcpu,
//          HV_X86_R14), rreg(vcpu, HV_X86_R15));
// }
